    ...
    let calPrice = ()=>{
        ...
        cartList.map((item)=>{
          if(cartList.length == 0){
            ...
            totalAmount = parseInt(totalAmount) + parseInt(item.price.slice(0, -1))*item.quantity
          }
         ...
         <section className="py-5">
                ...
                <div className="col-md-4 order-md-2 mb-4">
                    ...
                    <li className="list-group-item d-flex justify-content-between lh-condensed">
                        <div>
                        <h6 className="my-0">Cart Items</h6>
                        </div>
                ...
                <div className="col-md-8 order-md-1">
                    ...
                    <div className="d-block my-3">
                        <div className="form-check">
                        <input id="credit" name="paymentMethod" type="radio" className="form-check-input" readOnly checked required />
                    ...
                    <hr className="mb-4" />
                    <button className="btn btn-dark px-4 rounded-pill" type="submit" onClick={(e)=>submitOrder(e)}>Place Order</button>
                    </form>
                </div>
                </div>
            </div>
